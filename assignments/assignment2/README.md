...
2. [**LTestScene.cpp**]( https://github.com/wpumacay/wilbert-pumacay-graficos-2017-2/blob/master/assignments/assignment2/LTestScene.h ) : This file extends the basic scene and creates the necessary objects required by the assignment. You can see there the lights initialization, camera initialization and some entities creations, specially the sphere.

3. [**LBallEntity.cpp**]( https://github.com/wpumacay/wilbert-pumacay-graficos-2017-2/blob/master/assignments/assignment2/hw/LBallEntity.h ) : This file extends the base entity and creates the sphere mesh to be used in our application.
