...
namespace miniengine
{
    ...
    void LMesh::render( const LRenderInfo& rInfo )
    {
        ...
        if ( _program.id != 0 )
        {
            ...
            _matModel = glm::rotate( _matModel, glm::radians( rot.x ), glm::vec3( 1.0f, 0.0f, 0.0f ) );
            _matModel = glm::rotate( _matModel, glm::radians( rot.y ), glm::vec3( 0.0f, 1.0f, 0.0f ) );
            _matModel = glm::rotate( _matModel, glm::radians( rot.z ), glm::vec3( 0.0f, 0.0f, 1.0f ) );
